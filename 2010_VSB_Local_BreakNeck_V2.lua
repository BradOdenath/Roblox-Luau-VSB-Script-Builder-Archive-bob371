...
Tool.Name = "Neck"
Tool.Parent = owner.Backpack game.Players[who].Backpack
script.Parent = Tool
end
...
if blah == false then
pcall(function()
char.Break.RightWeld.C0 = CFrame.new(-0.9,1,1.3) * CFrame.fromEulerAnglesXYZ(-2,0.3,0.3)
char.Break.LeftWeld.C0 = CFrame.new(0.9,1,1.4) * CFrame.fromEulerAnglesXYZ(-2,-0.3,-0.3)
end)
asdfw:Remove()
...
if key == "e" then
pcall(function() asdfw:Remove() end)
char.Humanoid.PlatformStand = false
pcall(function()
char.Break.RightWeld.C0 = CFrame.new(-1.5,0,0) * CFrame.fromEulerAnglesXYZ(0,0,0)
char.Break.LeftWeld.C0 = CFrame.new(1.5,0,0) * CFrame.fromEulerAnglesXYZ(0,0,0)
