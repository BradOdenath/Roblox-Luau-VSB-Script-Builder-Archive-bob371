...
seat.CFrame = game.Players.LocalPlayer.Character.Torso.CFrame
...
--velo.velocity = Vector3.new(velo.velocity.x,200,velo.velocity.z)
end
end))
end))
end
...
if boosta then
velo.velocity = seat.CFrame.lookVector * 100
